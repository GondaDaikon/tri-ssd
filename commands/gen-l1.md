...
1. プロダクト名は？
2. 動作環境は？（Web / モバイル / デスクトップ / その他）
3. 想定ユーザーは？（個人 / 企業 / 開発者 / その他）
4. 解決したい課題は？
...
1. 技術的な制約は？（外部API連携 / 既存システム連携 / 技術指定 / その他）
2. 非機能要件は？（高可用性 / 高セキュリティ / 大量アクセス / その他）
3. 外部システム連携は？（API / DB / 認証基盤 / その他）

<!-- 業務/チーム開発の場合のみ -->
4. 組織的な制約は？（予算 / ツール制限 / 法規制 / その他）
