...
|---------|-----------|-------|--------|--------|
| Phase 1 | v2.0 | Critical | 基盤改善（ID管理、フロントマター、L2構成、技術選定） | 2025-01-23 |
| Phase 2 | v2.1 | High | 機能拡張（doc_status、変更伝播、ドメインテンプレート、NFR） | 2025-01-24 |
| Phase 3 | v2.2 | Medium | 品質向上（フェーズ明確化、定量基準、エラー標準化） | 2025-01-25 |
| Phase 4 | v2.3 | Operations | 運用改善（ライト版廃止、スキル統合、ログ管理、バリデーション） | 2025-01-26 |
| Phase 5 | v2.4 | Simplification | 構成簡素化（ドメインテンプレート廃止、正本一元化） | 2025-01-26 |
