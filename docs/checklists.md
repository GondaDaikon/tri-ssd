...
│     └─ doc_status: reviewed                                 │
├──────────────────────────────────────────────────────────────┤
│  4. /gen-rules で実装ルールのたたき台を生成                      │
│     └─ L3実装を通じて継続的に更新                              │
├──────────────────────────────────────────────────────────────┤
│  5. 実装する F-YYYYMMDD-nnn を選び、L3 機能Doc を AI でドラフト生成│
├──────────────────────────────────────────────────────────────┤
│  6. L3 ドラフトをレビュー・補正                                 │
│     └─ doc_status: reviewed                                 │
├──────────────────────────────────────────────────────────────┤
│  7. 実装・テストを行い、L3・コード・テストを同期                  │
...
├──────────────────────────────────────────────────────────────┤
│ 10. 適宜、AI による「全ドキュメント整合性チェック」を実行           │
...
- [ ] v0.1: 2ファイル構成（overview.md + phases.md）を確認
- [ ] doc_status を reviewed に更新
- [ ] `/gen-rules` で実装ルールのたたき台を生成（任意、L3実装前に推奨）
